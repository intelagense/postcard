const CardFront = () => {
    ...
    <div>
        ...
        <h1 className="-rotate-[5deg] text-7xl text-left font-super bottom-5 left-5 bg-bottom brightness-150 bg-[url('/public/images/clouds2.gif')] text-transparent bg-clip-text absolute text-orange-50 drop-shadow-[0_0_5px_rgba(0,0,0,1)]">Middle<br/>of Nowhere!</h1>
